...
import { AiOutlineHome, AiOutlineNotification, AiOutlineBarChart } from "react-icons/ai";
import { BsMegaphone, BsEyeFill } from "react-icons/bs";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <BsEyeFill className="me-2 fs-5" /> View Course Stream
      </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
